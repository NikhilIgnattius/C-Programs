...
int main()
{
    int response,response1,response2;
    
    printf("1.Acoustic");
    printf("\n2.Bass");
    printf("\nWhich guitar string name you want to know ?:");
    scanf("%d",&response);
    switch (response) {
        case 1:
            printf("Enter the guitar string number from bottom to top");
            printf("\n\t1.String no:1");
            printf("\n\t2.String no:2");
            printf("\n\t3.String no:3");
            printf("\n\t4.String no:4");
        ...
        case 1:
            printf("\nThis is the G string which is string no:1\n\n");
            exit(0);
            break;
            
        case 2:
            printf("\nThis is the D string which is string no:2\n\n");
            exit(0);
            break;
            
        case 3:
            printf("\nThis is the A string which is string no:3\n\n");
            exit(0);
            break;
            
        case 4:
            printf("\nThis is the E string which is string no:4\n\n");
            exit(0);
            break;
